...
pub fn run_dedupe(catalog: &Catalog, cfg: &DedupeConfig) -> anyhow::Result<DedupeReport> {
    ...
    for comp in &components {
        ...
        // Use total_cmp (not partial_cmp) for a true total order — NaN is
        // ordered rather than silently collapsed to Equal, matching the
        // determinism guarantee in the KNN sort.
