...
- ~~**Known follow-up (not blocking):** native-Windows *runtime* validated only by `cargo check` here.~~ **RESOLVED 2026-06-28:** photopipe builds (MSVC) and runs on a native Windows host.
